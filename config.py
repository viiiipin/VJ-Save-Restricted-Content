...
DB_URI = os.environ.get("DB_URI", "mongodb+srv://vipintech:hdgreyflnwpdgtk@cluster0.xtapcxa.mongodb.net/?appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
